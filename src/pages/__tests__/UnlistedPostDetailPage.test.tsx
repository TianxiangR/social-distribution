...
import UnlistedPostDetailPage from '../UnlistedPostDetailPage';
...
describe('Unlisted Post Detail Page', () => {
  it('renders post', async () => {
    const getPostSpy = jest.spyOn(apis, 'getUnlistedPostById').mockImplementation(() => Promise.resolve(new Response(JSON.stringify(postData))));
    act(() => {
      render(
        <BrowserRouter>
